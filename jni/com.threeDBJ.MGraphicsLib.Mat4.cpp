#include <com.threeDBJ.MGraphicsLib.Mat4.h>
...
//@line:701
	...
	static inline void matrix4_rot(float* mat, float* vec) {
	 ...
	 JNIEXPORT void JNICALL Java_com_threeDBJ_MGraphicsLib_Mat4_mul(JNIEnv* env, jclass clazz, jfloatArray obj_mata, jfloatArray obj_matb) {
...
JNIEXPORT void JNICALL Java_com_threeDBJ_MGraphicsLib_Mat4_mulVec___3F_3F(JNIEnv* env, jclass clazz, jfloatArray obj_mat, jfloatArray obj_vec) {
...
JNIEXPORT void JNICALL Java_com_threeDBJ_MGraphicsLib_Mat4_mulVec___3F_3FIII(JNIEnv* env, jclass clazz, jfloatArray obj_mat, jfloatArray obj_vecs, jint offset, jint numVecs, jint stride) {
	float* mat = (float*)env->GetPrimitiveArrayCritical(obj_mat, 0);
...
JNIEXPORT void JNICALL Java_com_threeDBJ_MGraphicsLib_Mat4_prj___3F_3F(JNIEnv* env, jclass clazz, jfloatArray obj_mat, jfloatArray obj_vec) {
	float* mat = (float*)env->GetPrimitiveArrayCritical(obj_mat, 0);
	float* vec = (float*)env->GetPrimitiveArrayCritical(obj_vec, 0);
...
JNIEXPORT void JNICALL Java_com_threeDBJ_MGraphicsLib_Mat4_prj___3F_3FIII(JNIEnv* env, jclass clazz, jfloatArray obj_mat, jfloatArray obj_vecs, jint offset, jint numVecs, jint stride) {
	float* mat = (float*)env->GetPrimitiveArrayCritical(obj_mat, 0);
	float* vecs = (float*)env->GetPrimitiveArrayCritical(obj_vecs, 0);
...
JNIEXPORT void JNICALL Java_com_threeDBJ_MGraphicsLib_Mat4_rot___3F_3F(JNIEnv* env, jclass clazz, jfloatArray obj_mat, jfloatArray obj_vec) {
	float* mat = (float*)env->GetPrimitiveArrayCritical(obj_mat, 0);
	float* vec = (float*)env->GetPrimitiveArrayCritical(obj_vec, 0);
...
JNIEXPORT void JNICALL Java_com_threeDBJ_MGraphicsLib_Mat4_rot___3F_3FIII(JNIEnv* env, jclass clazz, jfloatArray obj_mat, jfloatArray obj_vecs, jint offset, jint numVecs, jint stride) {
	float* mat = (float*)env->GetPrimitiveArrayCritical(obj_mat, 0);
	float* vecs = (float*)env->GetPrimitiveArrayCritical(obj_vecs, 0);
...
static inline jboolean wrapped_Java_com_threeDBJ_MGraphicsLib_Mat4_inv
...
JNIEXPORT jboolean JNICALL Java_com_threeDBJ_MGraphicsLib_Mat4_inv(JNIEnv* env, jclass clazz, jfloatArray obj_values) {
	float* values = (float*)env->GetPrimitiveArrayCritical(obj_values, 0);

	jboolean JNI_returnValue = wrapped_Java_com_threeDBJ_MGraphicsLib_Mat4_inv(env, clazz, obj_values, values);
...
static inline jfloat wrapped_Java_com_threeDBJ_MGraphicsLib_Mat4_det
(JNIEnv* env, jclass clazz, jfloatArray obj_values, float* values) {
...
JNIEXPORT jfloat JNICALL Java_com_threeDBJ_MGraphicsLib_Mat4_det(JNIEnv* env, jclass clazz, jfloatArray obj_values) {
	float* values = (float*)env->GetPrimitiveArrayCritical(obj_values, 0);

	jfloat JNI_returnValue = wrapped_Java_com_threeDBJ_MGraphicsLib_Mat4_det(env, clazz, obj_values, values);
