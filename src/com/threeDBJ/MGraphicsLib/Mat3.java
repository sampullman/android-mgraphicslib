...
public class Mat3 implements Serializable {
     ...
     * @return This matrix for the purpose of chaining operations. */
    public Mat3 setToRotation (float degrees) {
     ...
     * @return This matrix for the purpose of chaining operations. */
    public Mat3 setToTranslation (Vec2 translation) {
	this.val[M00] = 1;
	this.val[M10] = 0;
	this.val[M20] = 0;
     ...
     * @return This matrix for the purpose of chaining operations. */
    public Mat3 setToScaling (float scaleX, float scaleY) {
	val[M00] = scaleX;
	val[M10] = 0;
	val[M20] = 0;
	val[M01] = 0;
	...
	val[M00] = mat.val[Mat4.M00];
	val[M10] = mat.val[Mat4.M10];
	val[M20] = mat.val[Mat4.M20];
	val[M01] = mat.val[Mat4.M01];
	val[M11] = mat.val[Mat4.M11];
	val[M21] = mat.val[Mat4.M21];
	val[M02] = mat.val[Mat4.M02];
	val[M12] = mat.val[Mat4.M12];
	val[M22] = mat.val[Mat4.M22];
	return this;
    }
     ...
     * @return This matrix for the purpose of chaining. */
    public Mat3 trn (float x, float y) {
	val[M02] += x;
	val[M12] += y;
	return this;
    }
     ...
     * @param translation The translation vector.
     * @return This matrix for the purpose of chaining. */
    public Mat3 translate (Vec2 translation) {
	tmp[M00] = 1;
	tmp[M10] = 0;
	tmp[M20] = 0;
     ...
     * @return This matrix for the purpose of chaining. */
    public Mat3 scale (float scaleX, float scaleY) {
	tmp[M00] = scaleX;
	tmp[M10] = 0;
	tmp[M20] = 0;
	tmp[M01] = 0;
